 ...
 * - Réinitialiser uniquement les modules nécessaires après AJAX (ui:updated)
 * - Éviter les conflits DOM / double initialisation
 * - Stabiliser FetchForm et les modules dépendants du DOM dynamique
 * ------------------------------------------------------------------
 */
...
/**
 * Debug global des inputs (temporaire)
 */
...
/**
 * Réinitialisation ciblée après AJAX
 * (IMPORTANT : ne pas casser tout le DOM globalement)
 */
function resetInitializedState() {
  const selectors = [
    ".dropzone[data-initialized]",
    "[data-fetch-form][data-initialized]",
    "[data-collection][data-initialized]",
    "input[data-autocomplete][data-initialized]",
    "[data-action='toggle-favorite'][data-initialized]",
    ".double-slider[data-initialized]"
  ];
...
/**
 * Re-initialisation après requête AJAX globale
 */

export default class FetchForm {
  ...
  init() {
    // submit classique (pagination ou recherche directe)
    ...
    /**
     * filtres rapides (input texte, sliders)
     * -> reset page UNIQUEMENT ici
     */
  ...
  /**
   * reset pagination uniquement côté form
   * (NE PAS toucher URL sinon pagination cassée)
   */
  resetPage() {

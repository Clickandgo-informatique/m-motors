...
export default class AjaxManager {
  ...
  bindEvents() {
    document.body.addEventListener("click", e => {
      ...
      e.preventDefault();
      this.loadModal(trigger.dataset.ajaxUrl || trigger.href);
    });
    ...
    /**
     * IMPORTANT : fermeture modale
     * (ton HTML utilise data-modal-close)
     */
   ...
   */
  handleClick(e) {
    const trigger = e.target.closest('[data-module="ajax-modal"]');
    if (!trigger) return;

export default class Dropzone {
  ...
  addToQueue(files) {
    Array.from(files).forEach(file => {
      ...
      filename.classList.add("dz-filename");
      ...
      if (file.type.startsWith("image/")) {
        ...
        preview.innerHTML = `<div class="dz-file-preview dz-pdf">PDF</div>`;
      } else if (["doc", "docx"].includes(ext)) {
        preview.innerHTML = `<div class="dz-file-preview dz-word">WORD</div>`;
      } else if (["xls", "xlsx"].includes(ext)) {
        preview.innerHTML = `<div class="dz-file-preview dz-excel">EXCEL</div>`;
      } else {
        preview.innerHTML = `<div class="dz-file-preview dz-generic">${ext.toUpperCase()}</div>`;
      }

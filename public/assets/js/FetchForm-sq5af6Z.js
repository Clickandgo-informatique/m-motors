export default class FetchForm {
  ...
  renderPagination(data) {
    ...
    // INFO TEXT (TON BUG ACTUEL)
    const info = document.querySelector(".pagination-info-text");

    if (info && count !== null) {
      info.textContent = `${count} véhicules - Page ${current}/${max}`;
    }

    // PAGINATION HTML (TON BACKEND EST SOURCE)

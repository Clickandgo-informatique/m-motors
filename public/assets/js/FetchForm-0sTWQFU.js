...
export default class FetchForm {
  ...
  init() {
    ...
    this.form.addEventListener("change", () => {
      ...
      // pagination ne déclenche pas de debounce filters
  ...
  async send() {
    ...
    try {
      ...
      /**
       * PAGE HANDLING UNIQUE SOURCE OF TRUTH
       */
      ...
      // IMPORTANT :
      // - pagination définit déjà la page
      // - filters reset uniquement la page
      ...
      // CRITICAL FIX:
      // éviter que le flag pollue les prochains change events
      setTimeout(() => {

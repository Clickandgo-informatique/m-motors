...
export default class VehiclesFilter {
  constructor(form) {
    ...
    // --- URL AJAX pour les filtres / recherche ---
    this.url = "/vehicles/ajax/filters"; // point vers VehicleController::filters()

    // Conteneurs pour injection des résultats et pagination
  ...
  initViewToggle() {
    ...
    this.viewToggle.querySelectorAll("input[name='view']").forEach(input => {
      input.addEventListener("change", () => {
        ...
        this.submitFilters(); // relance AJAX pour recharger le rendu table/grid
      });
    });
  }

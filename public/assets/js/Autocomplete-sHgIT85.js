export default class Autocomplete {
  ...
  select(item) {
    ...
    if (form && form.__fetchFormInstance) {
      console.log("[Autocomplete] calling FetchForm.send()");
      form.__fetchFormInstance.send();
    } else if (form) {
      console.log("[Autocomplete] fallback requestSubmit()");
      form.requestSubmit();
    }
  ...
  syncHidden(value) {
    ...
    console.log("[Autocomplete] hidden set:", value);

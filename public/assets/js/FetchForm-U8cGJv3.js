...
export default class FetchForm {
    ...
    resetFilters() {
        ...
        // reset sliders (UI + state)
        this.form.querySelectorAll(".double-slider").forEach(slider => {
            if (typeof slider.forceReset === "function") {
                slider.forceReset();
            }
        });

        // refresh badges immediately (informative UI)
    ...
    async send() {
        ...
        try {
            ...
            // IMPORTANT: single pipeline UI
            EventBus.dispatch("ui:updated", {
                target: document
            });

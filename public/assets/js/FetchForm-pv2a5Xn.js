export default class FetchForm {
  ...
  async send() {
    ...
    try {
      ...
      // Reset pagination si ce n'est pas un clic direct sur pagination
      const pageInput = this.form.querySelector("input[name='page']");

      if (pageInput && !this.form.dataset.paginationTriggered) {
        pageInput.value = 1;
      }

      // reset flag
      delete this.form.dataset.paginationTriggered;

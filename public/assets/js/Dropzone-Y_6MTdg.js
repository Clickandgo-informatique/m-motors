  ...
  addToQueue(files) {
    ...
    arr.forEach(file => {
      ...
      // =========================
        ...
        previewContent = `<div class="dz-file-preview dz-pdf">PDF</div>`;
      }
      ...
      // =========================
        ...
        previewContent = `<div class="dz-file-preview dz-word">WORD</div>`;
      }
      ...
      // =========================
        ...
        previewContent = `<div class="dz-file-preview dz-excel">EXCEL</div>`;
      }
    ...
    `;
      ...
      deleteBtn.classList.add("dz-delete");

...
export function initVehicleFilters() {
  ...
  async function search() {
    try {
      ...
      // Injection dans les containers TWIG
      document.getElementById("vehicles-index-results").innerHTML = data.results;
      document.getElementById("pagination-info").innerHTML = data.pagination;

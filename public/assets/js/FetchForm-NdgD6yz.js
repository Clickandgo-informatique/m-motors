export default class FetchForm {
  ...
  init() {
    // soumission classique (recherche bouton)
    ...
    // déclenchement automatique sur filtres
  ...
  initResetButton() {
    ...
    resetBtn.addEventListener("click", e => {
      ...
      // fix important : laisser le DOM se mettre à jour avant submit
  ...
  resetFilters() {
    ...
    // reset uniquement les filtres hidden (pas les champs techniques si besoin)
  ...
  async send() {
    ...
    // sécurité reset : page forcée à 1

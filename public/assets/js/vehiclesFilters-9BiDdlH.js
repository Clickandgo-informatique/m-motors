...
export default class VehiclesFilter {
   ...
   * Chaque slider dispatch un événement "sliderChanged" pour déclencher la soumission AJAX
   */
  initSliders() {
    ...
    sliders.forEach(slider => {
      // Initialisation et création de la méthode resetSlider() pour chaque slider
  ...
  initEvents() {
    ...
    if (this.summaryContainer) {
      this.summaryContainer.addEventListener("click", e => {
        ...
        // Sliders (range) : reset visuel + inputs

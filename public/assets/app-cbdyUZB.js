...
function initAutocomplete() {
  const inputs = document.querySelectorAll("[data-module='autocomplete']");

  console.log("[Autocomplete] found:", inputs.length);
  ...
  inputs.forEach(input => {
    ...
    try {
      console.log("[Autocomplete] init:", input);

      new Autocomplete(input);
    } catch (e) {
      console.error("[Autocomplete] crash:", e, input);
    }
  });
}

/* ==========================================================
   FETCH FORMS (LISTING AJAX)
========================================================== */
...
/* ==========================================================
   AJAX MANAGER (MODALES + ACTIONS GLOBALES)
========================================================== */
